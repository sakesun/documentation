...
*Applications* page, whether they submitted through the company website, emailed a resume to the
...
certifications, etc. :doc:`Custom interviews <../../hr/recruitment/new_job>` can be formatted to
suit each individual job position's needs.
...
.. _recruitment/recruitment_flow/Scontract-proposal:
